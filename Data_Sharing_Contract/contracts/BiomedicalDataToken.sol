...
contract BioMedicalDataToken {
    ...
    //if users publish their finding using the data contributor provided, both users and contributors could receive tokens.
    function incentiveForPublication(address sharer, address receiver) public returns (bool) {
        balances[receiver] = balances[receiver].add(30);
        balances[sharer] = balances[sharer].add(30);
        return true;
    }
